# p-8383f5e5 decomposition (step 800000)
...
root = Path("p-8383f5e5-decomposition-800000")
loaded = open_jax_run(
    root / "runs" / "p-8383f5e5",
    step=800000,
    data_root=root,
)
...
Source run: https://wandb.ai/goodfire/param-decomp/runs/p-8383f5e5
